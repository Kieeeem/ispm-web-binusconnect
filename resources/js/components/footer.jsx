...
const Footer = () => {
    return(
      ...
      {/* Top section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 flex flex-col md:flex-row md:justify-between md:items-start space-y-8 md:space-y-0">
        {/* Logo */}
      ...
      {/* Bottom copyright */}
      <div>
        <p className="max-w-4xl mx-auto px-4 py-6 text-center text-[16px] md:text-[18px]">
